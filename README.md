...
- ✅ **The grounding brain is real and proven** — 198 public stores · 157,946 public source chunks, dual embeddings, cross-encoder rerank, plugin (MCP tool + explicit skills; automatic hooks retired), all re-runnable.
