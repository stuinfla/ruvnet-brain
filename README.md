...
### 🧠 RuvNet Brain — [![RuvNet Brain version 4.3.0-dev — updated 2026-07-30 03:24 EDT](https://img.shields.io/badge/version_4.3.0--dev-updated_2026--07--30_03:24_EDT-1E90FF?style=for-the-badge&labelColor=0757BA)](https://github.com/stuinfla/ruvnet-brain/blob/main/plugin/.claude-plugin/plugin.json)
...
- ✅ **The grounding brain is real and proven** — 1 public stores · 3,121 public source chunks (1 built stores incl. private), dual embeddings, cross-encoder rerank, plugin (MCP tool + enforcement hook + skill), all re-runnable.
