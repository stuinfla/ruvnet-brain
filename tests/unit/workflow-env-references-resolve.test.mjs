...
const AMBIENT = new Set([
  ...
  'GITHUB_STEP_SUMMARY', 'GITHUB_RUN_ID', 'GITHUB_RUN_ATTEMPT', 'GITHUB_RUN_NUMBER', 'GITHUB_ACTOR', 'GITHUB_SERVER_URL',
  'RUNNER_TEMP', 'RUNNER_OS', 'RUNNER_ARCH', 'RUNNER_TOOL_CACHE', 'HOME', 'PATH', 'PWD', 'SHELL',
  'USER', 'TMPDIR', 'CI', 'NODE_AUTH_TOKEN', 'BASH_VERSION', 'SECONDS', 'IFS', 'OSTYPE', 'HOSTNAME', 'LANG',
]);
