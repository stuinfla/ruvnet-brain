...
export const OPERATIONAL_FIXTURES = [
  ...
  { id: 'named-ruflo-ipfs', class: 'named', query: 'How does Ruflo use IPFS to share learned patterns across projects?', expectedRepos: ['ruflo'], expectedFact: 'IPFS-based cross-project pattern transfer', oraclePath: 'evals/oracles/ruflo-ipfs-plugin.json' },
