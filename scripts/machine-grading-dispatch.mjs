...
import { encodeGradingInputs } from './machine-grading-transport.mjs';
...
export function main(argv=process.argv.slice(2), env=process.env) {
  try {
    ...
    const values=encodeGradingInputs(sha,{fable_receipt_b64:read(fable),astra_receipt_b64:read(astra),release_identity_b64:read(identity)});
