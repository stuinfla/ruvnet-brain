...
const FULL_HINTS = {
  ...
  // ruvnet/agent-harness-generator was renamed upstream to ruvnet/metaharness; the kb store
  // was fully wiped and re-imported under the new name (not just relabeled) to avoid stale
  // internal metadata (meta.json's clone path, embed.json's builtFrom) that a raw file rename
