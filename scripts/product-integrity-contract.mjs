...
export const PRODUCT_INTEGRITY_OBLIGATIONS = Object.freeze([
  ...
  make('S-10', 'Machine grading by two vendors over identical immutable inputs with authenticated native identities governed by the canonical receipt validator', 'ProductIntegrityCase', ['PublicVerification'], ['scripts/public-verification-aggregate.mjs', '.github/workflows/protected-release.yml'], ['tests/unit/public-verification-aggregate.test.mjs', 'tests/unit/protected-release-workflow.test.mjs'], ['ruvnet-brain-independent-review', 'ruvnet-brain-public-verification-aggregate']),
