...
status: Proposed  # 2026-09-14: 19 of 20 steps MERGED to main and CI-green (0-9, 12-18 + step 15 + the step-5 P1 remediation). Steps 10, 11, 19 are owner-gated. NOTE: step 15's C3 gate is fail-closed on an oracle that does not exist yet, so corpus publication AND the local rehearsal are BLOCKED until data/retrieval-accuracy-oracle.json is produced with step 14's producer. That is the gate working. Per-step table is the record.
date: 2026-09-13
updated: 2026-09-14
