...
status: Proposed  # 2026-09-14: 18 of 20 steps MERGED to main and CI-green (0-9, 12-18 + the step-5 P1 remediation). Steps 10, 11, 19 are owner-gated: 10 needs a real protected publication, 11 needs a published seed to point at, 19 needs three real scheduled nights. THREE OWNER ACTIONS listed in the currency log. Per-step table is the record.
date: 2026-09-13
updated: 2026-09-14
