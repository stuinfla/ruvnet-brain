...
status: Proposed  # 2026-09-14: 12 steps -> 19 after the owner-acceptance Dual deliberation (C1 PARTIAL, C2 PARTIAL, C3 NO, C4 NO). Steps 0-7, 12, 13 MERGED to main (10 of 20); step 5's remediation carries a Dual CONDITIONAL with three open P1s; 8-11, 14-19 outstanding. Per-step table + currency log are the record.
date: 2026-09-13
updated: 2026-09-14
