...
| 2026-08-23 | The Windows candidate slice serializes Vitest workers around the installer-import suites. | The exact-SHA failed receipt isolated a platform execution boundary; no release authority, artifact, or publication mutation changed. |
