...
| 2026-08-23 | Windows Vitest execution is serialized for the installer-import candidate slice. | Run `32654414505` isolated the failure to two concurrent installer-import suites with no failed assertions; this is containment, not test removal or threshold relaxation. |
