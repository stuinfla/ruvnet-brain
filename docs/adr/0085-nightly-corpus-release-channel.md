...
|---|---|---|
| 2026-09-17 | Reviewed the nightly channel decision and governed workflow/publisher paths at integration HEAD; no unattended nightly customer delivery is proven. | `.github/workflows/corpus-seed.yml`; reviewed_digest 3d00141d6363. |
