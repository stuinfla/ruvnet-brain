...
`Brain version: v4.0.34-dev · Built: 2026-08-08 · Covers: 71/194 repos built @ pinned SHAs (see data/manifest.json)`
...
- A **portable brain** over **71 RuvNet building-block repos**, embedded and indexed (54 at pinned SHAs; concepts, ruv-gists, ruv-meetings are generated stores without a single source SHA).
...
3. **Pull in an uncovered repo on demand** (any of the 194 catalogued, or any rUv repo):
   ```
